...
async function main() {
  ...
  const publicTokenAmount = hre.ethers.utils.parseEther("4666666.666666666666666666"); // USD70,000 worth of PixelVerse tokens at USD0.015 each
  ...
  if (network === "mainnet") {
    ...
    crowdsaleOpeningTime = 1635926400; // 3 Nov 2021 04:00 PM GMT+8
    crowdsaleClosingTime = 1636016400; // 4 Nov 2021 05:00 PM GMT+8
