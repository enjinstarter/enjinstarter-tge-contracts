...
async function main() {
  ...
  const publicTokenAmount = hre.ethers.utils.parseEther("180"); // USD9 worth of sale tokens at USD0.05 each for guaranteed round

  const crowdsaleRate = hre.ethers.utils.parseEther("0.05");
  ...
  if (network === "bsc-mainnet") {
    publicVestingSchedule = {
      cliffDurationDays: 0,
      percentReleaseAtScheduleStart: hre.ethers.utils.parseEther("25"),
      percentReleaseForEachInterval: hre.ethers.utils.parseEther("25"),
      intervalDays: 30,
      gapDays: 0,
      numberOfIntervals: 3,
    ...
    crowdsaleOpeningTime = 1636441200; // 9 Nov 2021 03:00 PM GMT+8
    crowdsaleClosingTime = 1636455600; // 9 Nov 2021 07:00 PM GMT+8
