...
async function main() {
  ...
  const publicTokenAmount = hre.ethers.utils.parseEther("142.85714285"); // USD0.50 worth of sale tokens at USD0.0035 each for first come first served round

  const crowdsaleRate = hre.ethers.utils.parseEther("0.0035");
  ...
  if (network === "bsc-mainnet") {
    ...
    crowdsaleOpeningTime = 1637334000; // 19 Nov 2021 11:00 PM GMT+8
    crowdsaleClosingTime = 1637377200; // 20 Nov 2021 11:00 AM GMT+8
    ...
    crowdsaleClosingTime = crowdsaleOpeningTime + 1 * 24 * 60 * 60; // close 1 day after open
  ...
  console.log("Crowdsale (FCFS):", launchpadCrowdsaleContract.address);
