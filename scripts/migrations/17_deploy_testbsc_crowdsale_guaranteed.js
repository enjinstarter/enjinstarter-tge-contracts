...
async function main() {
  ...
  const publicTokenAmount = hre.ethers.utils.parseEther("2250"); // USD90 worth of sale tokens at USD0.04 each for guaranteed round
  ...
  if (network === "bsc-mainnet") {
    ...
    crowdsaleOpeningTime = 1636455600; // 9 Nov 2021 07:00 PM GMT+8
    crowdsaleClosingTime = 1636470000; // 9 Nov 2021 11:00 PM GMT+8
    ...
    launchpadWhitelistAddress = process.env.POLYGON_MAINNET_LAUNCHPAD_WHITELIST_ADDRESS;
    crowdsaleAdmin = process.env.POLYGON_MAINNET_LAUNCHPAD_CROWDSALE_ADMIN;
    crowdsaleWallet = process.env.POLYGON_MAINNET_LAUNCHPAD_CROWDSALE_WALLET;
    ...
    launchpadWhitelistAddress = process.env.POLYGON_MUMBAI_LAUNCHPAD_WHITELIST_ADDRESS;
    crowdsaleAdmin = process.env.POLYGON_MUMBAI_LAUNCHPAD_CROWDSALE_ADMIN;
    crowdsaleWallet = process.env.POLYGON_MUMBAI_LAUNCHPAD_CROWDSALE_WALLET;

    crowdsalePaymentTokensInfo = [
      {
        // USDC
        paymentToken: "0x2058A9D7613eEE744279e3856Ef0eAda5FCbaA7e",
        paymentDecimal: 6,
        rate: crowdsaleRate,
      },
      {
        // USDT
        paymentToken: "0xBD21A10F619BE90d6066c941b04e340841F1F989",
        paymentDecimal: 6,
        rate: crowdsaleRate,
      },
    ];
  ...
  console.log("Public Vesting (Guaranteed):", publicVestingContract.address);
  console.log("Crowdsale with Vesting (Guaranteed):", launchpadCrowdsaleContract.address);
  ...
  if (network !== "bsc-mainnet" && network !== "mainnet" && network !== "polygon-mainnet") {
