...
async function main() {
  ...
  const publicTokenAmount = hre.ethers.utils.parseEther("250"); // USD10 worth of sale tokens at USD0.04 each for first come first served round
  ...
  if (network === "bsc-mainnet") {
    ...
    crowdsaleOpeningTime = 1636531200; // 10 Nov 2021 04:00 PM GMT+8
    crowdsaleClosingTime = 1636621200; // 11 Nov 2021 05:00 PM GMT+8
