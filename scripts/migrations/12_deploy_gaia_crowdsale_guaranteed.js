...
async function main() {
  ...
  const publicTokenAmount = hre.ethers.utils.parseEther("1199700"); // USD191,952 worth of GAIA tokens at USD0.16 each for guaranteed round
  ...
  if (network === "mainnet") {
    ...
    crowdsaleOpeningTime = 1635678000; // 31 Oct 2021 07:00 PM GMT+8
    crowdsaleClosingTime = 1635692400; // 31 Oct 2021 11:00 PM GMT+8
  ...
  console.log("GAIA Crowdsale (Guaranteed):", launchpadCrowdsaleContract.address);
