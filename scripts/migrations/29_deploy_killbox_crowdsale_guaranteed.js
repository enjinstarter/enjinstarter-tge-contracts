...
async function main() {
  ...
  const publicTokenAmount = hre.ethers.utils.parseEther("2142.85714285"); // USD7.50 worth of sale tokens at USD0.0035 each for guaranteed round
  ...
  if (network === "bsc-mainnet") {
    ...
    crowdsaleOpeningTime = Math.floor((Date.now() + 30 * 60 * 1000) / 1000); // open 30 mins later
    crowdsaleClosingTime = crowdsaleOpeningTime + 1 * 24 * 60 * 60; // close 1 days after open
