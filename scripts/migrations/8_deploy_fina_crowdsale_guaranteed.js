...
async function main() {
  ...
  const publicTokenAmount = hre.ethers.utils.parseEther("187500"); // 75% of USD100k worth of FINA tokens at USD0.4 each for guaranteed round
  ...
  if (network === "mainnet") {
    ...
    crowdsaleOpeningTime = 1633924800; // 11 Oct 2021 12:00 PM GMT+8
    crowdsaleClosingTime = 1633928400; // 11 Oct 2021 01:00 PM GMT+8
  ...
  console.log("FINA Crowdsale (Guaranteed):", finaCrowdsaleContract.address);
